        ...
        >
          ...
          <div className="mt-32 pt-24 border-t border-[var(--border-color)] grid md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="text-[var(--text-muted)] text-xs leading-relaxed uppercase">We show up on time and finish the job properly, every time.</p>
            </div>
            <div>
              <h4 className="text-[var(--text-main)] font-bold mb-4 uppercase tracking-widest text-sm">Quality</h4>
              <p className="text-[var(--text-muted)] text-xs leading-relaxed uppercase">Our local team uses only SABS-approved materials for all installations.</p>
            </div>
            <div>
              <h4 className="text-[var(--text-main)] font-bold mb-4 uppercase tracking-widest text-sm">Local Pride</h4>
              <p className="text-[var(--text-muted)] text-xs leading-relaxed uppercase">Based in Witbank, we are proud to serve our community and beyond.</p>
            </div>
          </div>
        </motion.div>
      </section>
